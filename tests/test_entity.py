...
class TestTeam:
    ...
    def test_party_padding(self) -> None:
...
class TestDataClasses:
    ...
    def test_individual_values_clamping(self) -> None:
    ...
    def test_individual_values_total(self) -> None:
    ...
    def test_move_pp_percentage_zero_max(self) -> None:
    ...
    def test_experience_level_progress(self) -> None:
    ...
    def test_pokemon_stats_total(self) -> None:
    ...
    def test_type_value_weights_defaults(self) -> None:
    ...
    def test_type_value_weights_get_weight(self) -> None:
    ...
    def test_carry_score_breakdown_to_dict(self) -> None:
    ...
    def test_evolution_decision_creation(self) -> None:
    ...
    def test_party_slot_creation(self) -> None:
    ...
    def test_critical_pre_evo_moves_defined(self) -> None:
    ...
    def test_critical_pre_evo_moves_content(self) -> None:

...
class TestParseToolCallCodeFenced:
    ...
    def test_code_fenced_press_button(self):  # type: ignore
    ...
    def test_code_fenced_wait(self):  # type: ignore
    ...
    def test_code_fenced_combo(self):  # type: ignore
        resp = (
            '```json\n'
    ...
    def test_code_fenced_no_json_tag(self):  # type: ignore
    ...
    def test_code_fenced_with_extra_text(self):  # type: ignore
    ...
    def test_code_fenced_invalid_json_returns_none(self):  # type: ignore
        resp = '```json\n{not valid json}\n```'
        result = parse_tool_call(resp)
...
class TestParseToolCallInline:
    ...
    def test_bare_json_press_button(self):  # type: ignore
    ...
    def test_bare_json_wait(self):  # type: ignore
    ...
    def test_openai_style_tool_calls_array(self):  # type: ignore
    ...
    def test_openai_style_uses_first_tool_call(self):  # type: ignore
        resp = (
            '{"tool_calls": ['
    ...
    def test_empty_response_returns_none(self):  # type: ignore
        result = parse_tool_call("")
        assert result is None

    def test_no_tool_call_returns_none(self):  # type: ignore
        resp = "The screen shows Professor Oak's lab. I see a Poké Ball on the table."
        result = parse_tool_call(resp)
        assert result is None

    def test_garbage_json_fallback(self):  # type: ignore
...
class TestExecuteToolCallPressButton:
    ...
    def test_press_button_calls_emulator(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_press_button_default_duration(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_press_button_up(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_press_button_missing_button_raises(self):  # type: ignore
        emu = _mock_emulator()
...
class TestExecuteToolCallInvalid:
    ...
    def test_unknown_tool_returns_error(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_nonexistent_tool_returns_error(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_empty_tool_name_returns_error(self):  # type: ignore
        emu = _mock_emulator()
...
class TestExecuteToolCallCombo:
    ...
    def test_combo_presses_multiple_buttons(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_combo_single_button(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_combo_default_duration(self):  # type: ignore
        emu = _mock_emulator()
    ...
    def test_combo_missing_buttons_raises(self):  # type: ignore
        emu = _mock_emulator()
...
class TestToolSchema:
    ...
    def test_all_tools_have_required_fields(self):  # type: ignore
    ...
    def test_tool_schema_names_match(self):  # type: ignore
    ...
    def test_press_button_has_required_button(self):  # type: ignore
    ...
    def test_wait_has_required_frames(self):  # type: ignore
    ...
    def test_combo_has_required_buttons(self):  # type: ignore

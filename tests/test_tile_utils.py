...
class TestStripToTsv:
    ...
    def test_sample_constant_matches(self):
...
class TestNormalizeStripTerrain:
    ...
    def test_tsv_detected_and_converted(self):
...
class TestExtractTileStrip:
    ...
    def test_extract_north_strip(self):
    ...
    def test_extract_south_strip(self):
    ...
    def test_extract_east_strip(self):
    ...
    def test_extract_west_strip(self):
    ...
    def test_east_strip_is_horizontal_layout(self):
    ...
    def test_partial_strip_truncated(self):
...
class TestObsPatchTsvParsing:
    ...
    def test_terrain_tsv_overrides_empty_terrain(self):
    ...
    def test_terrain_takes_priority_over_terrain_tsv(self):
...
class TestMapIntegratorTsvStrip:
    ...
    def test_apply_tsv_strip_north(self):
    ...
    def test_apply_tsv_strip_east(self):
    ...
    def test_apply_mixed_packed_and_tsv(self):
...
class TestViewportConstants:
    ...
    def test_gb_screen_dimensions(self):
        assert GB_SCREEN_PX[0] == 160  # width
        assert GB_SCREEN_PX[1] == 144  # height

    def test_tiles_fit_screen_evenly(self):
    ...
    def test_viewport_tile_width_reasonable(self):

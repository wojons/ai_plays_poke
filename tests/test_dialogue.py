...
from src.core.dialogue import (
    ...
    create_dialog_parser,
    create_text_speed_controller,
    create_menu_navigator,
    create_npc_interaction,
)
...
class TestDialogParser:
    ...
    def test_parse_simple_greeting(self) -> None:
    ...
    def test_parse_shop_dialog(self) -> None:
    ...
    def test_parse_item_gift(self) -> None:
    ...
    def test_parse_healing_dialog(self) -> None:
    ...
    def test_parse_progression_dialog(self) -> None:
    ...
    def test_extract_pokemon_entities(self) -> None:
    ...
    def test_extract_item_entities(self) -> None:
...
Are you a Pokemon Trainer?"""
    ...
    def test_parse_choice_dialog(self) -> None:
    ...
    def test_parse_important_line_detection(self) -> None:
    ...
    def test_secondary_intent_detection(self) -> None:
    ...
    def test_parse_empty_dialog(self) -> None:
    ...
    def test_parse_trainer_introduction(self) -> None:
    ...
    def test_actions_required_extraction(self) -> None:
    ...
    def test_information_extraction(self) -> None:
    ...
    def test_pokemon_database_completeness(self) -> None:
    ...
    def test_location_database_completeness(self) -> None:
    ...
    def test_item_database_completeness(self) -> None:
...
class TestTextSpeedController:
    ...
    def test_get_optimal_speed_short_dialog(self) -> None:
    ...
    def test_get_optimal_speed_long_dialog(self) -> None:
        ...
        lines = [
            DialogLine(f"Line {i}", f"LINE {i}", None, None, DialogIntent.INFORMATION)
            for i in range(10)
        ]
        dialog = DialogEntry(
            lines=lines,
    ...
    def test_should_skip_remaining(self) -> None:
...
class TestMenuNavigator:
    ...
    def test_detect_main_menu(self) -> None:
    ...
    def test_detect_battle_menu(self) -> None:
    ...
    def test_detect_shop_menu(self) -> None:
    ...
    def test_detect_yes_no_dialog(self) -> None:
    ...
    def test_create_menu_state(self) -> None:
    ...
    def test_calculate_navigation_path(self) -> None:
    ...
    def test_navigate_to_option(self) -> None:
    ...
    def test_unknown_menu_type(self) -> None:
...
class TestNPCInteraction:
    ...
    def test_interact_with_npc(self) -> None:
    ...
    def test_detect_battle_initiation(self) -> None:
        """Should detect when battle is initiated"""
        result = self.interaction.interact_with_npc(
            "RIVAL", "Let's battle! I challenge you!"
        )
    ...
    def test_extract_hints(self) -> None:
    ...
    def test_get_npc_info(self) -> None:
    ...
    def test_create_new_npc(self) -> None:
        """Should create entry for unknown NPC"""
        result = self.interaction.interact_with_npc("UNKNOWN NPC", "Hello there!")
    ...
    def test_determine_action(self) -> None:
        ...
        result = self.interaction.interact_with_npc(
            "SHOPKEEPER", "Welcome! What would you like to buy?"
        )

        assert result.action_taken in ["enter_shop", "acknowledge", "continue"]

    def test_npc_database_completeness(self) -> None:
    ...
    def test_interaction_with_empty_dialog(self) -> None:
        """Should handle empty dialog"""
    ...
    def test_quest_detection(self) -> None:
        ...
        result = self.interaction.interact_with_npc(
            "NPC", "Please help me find my lost Pokemon!"
        )
...
class TestDialogueManager:
    ...
    def test_process_dialog(self) -> None:
    ...
    def test_handle_npc_interaction(self) -> None:
    ...
    def test_navigate_menu(self) -> None:
        ...
        success, presses = self.manager.navigate_menu("POKEMON  BAG  FIGHT", "BAG")
...
class TestDialogTypes:
    ...
    def test_battle_dialog_type(self) -> None:
    ...
    def test_item_dialog_type(self) -> None:
    ...
    def test_information_dialog_type(self) -> None:
...
class TestIntentClassification:
    ...
    def test_threat_intent(self) -> None:
    ...
    def test_choice_intent(self) -> None:
    ...
    def test_reward_intent(self) -> None:
...
class TestFactoryFunctions:
    ...
    def test_create_dialogue_system(self) -> None:
    ...
    def test_create_dialog_parser(self) -> None:
    ...
    def test_create_text_speed_controller(self) -> None:
    ...
    def test_create_menu_navigator(self) -> None:
    ...
    def test_create_npc_interaction(self) -> None:
...
class TestEdgeCases:
    ...
    def test_very_long_dialog(self) -> None:
    ...
    def test_numbers_in_dialog(self) -> None:
    ...
    def test_empty_lines_in_dialog(self) -> None:
    ...
    def test_dialog_with_only_entities(self) -> None:
...
class TestDialogEntry:
    ...
    def test_dialog_entry_creation(self) -> None:
    ...
    def test_dialog_entry_with_entities(self) -> None:
    ...
    def test_dialog_entry_with_reward(self) -> None:
...
class TestMenuState:
    ...
    def test_menu_option_properties(self) -> None:
        """Should have correct option properties"""
        option = MenuOption(index=0, text="POKEMON", row=0, col=0, is_selected=True)
...
class TestNPCInfo:
    ...
    def test_npc_info_creation(self) -> None:

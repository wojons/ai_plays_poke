...
class TestScanMemoryForPokemonData:
    ...
    def test_finds_nonzero_pairs(self) -> None:
    ...
    def test_default_scan_range(self) -> None:
        pyboy = make_pyboy(default=1)
    ...
    def test_index_error_breaks_loop(self) -> None:
        memory = MagicMock()
    ...
    def test_index_error_mid_scan_keeps_prior_results(self) -> None:
        calls = {"n": 0}
...
class TestReadPokemonStats:
    ...
    def test_values_from_memory(self) -> None:
        values = {
            0xD158: 35,
            0xD159: 40,
            0xD16A: 12,
...
class TestMemoryScanningFunction:
    ...
    def test_rom_missing_returns_false(self) -> None:
    ...
    def test_no_data_found_still_completes(self) -> None:
